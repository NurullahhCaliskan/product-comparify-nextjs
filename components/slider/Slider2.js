    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide>
                    <img className="rounded" src="/assets/imgs/placeholders/img-6.png" alt="Product Comparify" />
                </SwiperSlide>
                <SwiperSlide>

                    <img className="rounded" src="/assets/imgs/placeholders/img-7.png" alt="Product Comparify" />
                </SwiperSlide>
                <SwiperSlide>

                    <img className="rounded" src="/assets/imgs/placeholders/img-8.png" alt="Product Comparify" />
                </SwiperSlide>
            </Swiper>
