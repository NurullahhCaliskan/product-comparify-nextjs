                        ...
                        <div className="flex flex-wrap -mx-3">
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".1s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-6.png" alt="Product Comparify" />
                                    </a>
                                </Link>
                            ...
                            <div className="w-full lg:w-2/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".3s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-7.png" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <p className="mt-6 text-sm text-blue-400">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".1s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-8.png" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".3s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-9.jpg" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".1s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-10.jpg" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".3s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-11.jpg" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".5s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-12.jpg" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
                            ...
                            <div className="w-full lg:w-1/3 px-3 mb-12 wow animate__animated animate__fadeIn animated hover-up-5" data-wow-delay=".3s">
                                <Link href="/blog-single">
                                    <a>
                                        <img className="h-80 w-full object-cover rounded" src="/assets/imgs/placeholders/img-13.jpg" alt="Product Comparify" />
                                    </a>
                                </Link>
                                <p className="mt-6 text-sm text-blue-400">
                                    <Link href="/blog-2">
