                        ...
                        <div className="container">
                            <div className="max-w-2xl mx-auto">
                                ...
                                <div className="flex justify-center mb-8">
                                    <img className="w-12 h-12 object-cover rounded-full" src="/assets/imgs/placeholders/avatar-8.png" alt="Product Comparify" />
                                    <div className="pl-4">
                                ...
                                <div className="space-y-4">
                                    <div className="flex">
                                        <div className="flex-shrink-0 mr-3">
                                            <img className="mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10" src="/assets/imgs/placeholders/avatar-2.png" alt="Product Comparify" />
                                        </div>
                                        <div className="flex-1 border border-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
                                            ...
                                            <div className="mt-4 flex items-center">
                                                <div className="flex -space-x-2 mr-2">
                                                    <img className="rounded-full w-6 h-6 border border-white" src="/assets/imgs/placeholders/avatar-3.png" alt="Product Comparify" />
                                                    <img className="rounded-full w-6 h-6 border border-white" src="/assets/imgs/placeholders/avatar-4.png" alt="Product Comparify" />
                                                </div>
                                    ...
                                    <div className="flex">
                                        <div className="flex-shrink-0 mr-3">
                                            <img className="mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10" src="/assets/imgs/placeholders/avatar-5.png" alt="Product Comparify" />
                                        </div>
                                        <div className="flex-1 border border-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex">
                                                    <div className="flex-shrink-0 mr-3">
                                                        <img className="mt-3 rounded-full w-6 h-6 sm:w-8 sm:h-8" src="/assets/imgs/placeholders/avatar-6.png" alt="Product Comparify" />
                                                    </div>
                                                ...
                                                <div className="flex">
                                                    <div className="flex-shrink-0 mr-3">
                                                        <img className="mt-3 rounded-full w-6 h-6 sm:w-8 sm:h-8" src="/assets/imgs/placeholders/avatar-7.png" alt="Product Comparify" />
                                                    </div>
                                                    <div className="flex-1 bg-gray-50 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed">
                                                        <strong>Dany </strong>
                                                        <span className="text-xs text-gray-400">3:34 PM</span>
