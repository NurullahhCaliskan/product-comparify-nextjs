        ...
        <>
            <Layout>
                <section className="pb-20">
                        ...
                        <div className="container">
                            <div className="max-w-2xl mx-auto">
                                <div className="text-center mb-6">
                                    ...
                                    <h2 className="text-4xl md:text-5xl mt-4 font-bold font-heading">Privacy Policy</h2>
                                </div>
                    ...
                    <div className="container">
                        <div className="max-w-2xl mx-auto">
                            <p className="mb-6 leading-loose text-blueGray-400">Product Comparify Privacy Policy

                                Product Comparify "the App” provides product price alert system "the Service" to merchants who use Shopify to power their stores. This Privacy Policy describes how personal information is collected, used, and shared when you install or use the App in connection with your Shopify-supported store.
                                ...
                                Contact Us For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at productcomparify@gmail.com .</p>
