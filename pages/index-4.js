                        ...
                        <div className="py-12 text-center">
                            <div className="max-w-2xl mx-auto mb-8">
                                ...
                                <p className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn">
                                    We are <strong className="text-blue-500">Product Comparify</strong>, a Creative Design{" "}
                            ...
                            <div className="relative w-full md:w-1/2 lg:w-3/5 px-3 bg-blue-500 rounded-r overflow-hidden">
                                ...
                                <div className="absolute right-0 bottom-0">
                                    <div className="flex items-center h-full">
                                        <img className="h-80" src="/assets/imgs/illustrations/online-shopping.png" alt="Product Comparify" />
                                    </div>
                                </div>
                            </div>
                        </div>
