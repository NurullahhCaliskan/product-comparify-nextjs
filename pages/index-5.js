            ...
            <Layout>
                <section className="pb-8 bg-top bg-cover bg-no-repeat relative -mt-24 pt-24" style={{"backgroundImage":"url('assets/imgs/backgrounds/intersect.svg')"}}>
                    <div className="hidden md:block absolute top-0 left-0 mt-32">
                        <img className="h-64 lg:h-80 jump" src="/assets/imgs/illustrations/at_the_park.svg" alt="Product Comparify" />
                    </div>
                    <div className="hidden md:block absolute top-0 right-0 mt-32">
                        <img className="h-64 lg:h-80 jump" src="/assets/imgs/illustrations/delivered.svg" alt="Product Comparify" />
                    </div>
                    <div className="container">
                        <div className="mt-12 mb-12">
                            <div className="max-w-lg mx-auto mb-8 text-center">
                                ...
                                <p className="text-blueGray-400 leading-relaxed wow animate__animated animate__fadeIn">We are <strong className="text-blue-500">Product Comparify</strong>, a Creative Design <span className="typewrite d-inline text-brand" data-period="3000" data-type='["Web Agency", "Social Marketing" ]'>
                    ...
                    <div className="container py-12 mx-auto">
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full md:w-1/2 px-3 order-0 md:order-1 mb-12 md:mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <img className="sm:max-w-sm lg:max-w-full mx-auto" src="/assets/imgs/illustrations/podcast.svg" alt="Product Comparify" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container">
                        <div className="flex flex-wrap lg:flex-nowrap">
                            <div className="flex flex-wrap lg:max-w-sm mx-auto">
                                <img className="jump sm:max-w-sm lg:max-w-full mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".5s" src="/assets/imgs/illustrations/tasks.svg" alt="Product Comparify" />
                            </div>
                            <div className="w-full lg:w-auto">
                ...
                <div class="container">
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-1/2 py-5 md:px-5 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            <div class="px-6 py-10 bg-white shadow rounded">
                                <div class="flex items-center mb-4">
                                    <img class="h-16 w-16 rounded-full object-cover" src="assets/imgs/placeholders/img-1.png" alt="Product Comparify" />
                                    <div class="pl-4">
                        ...
                        <div class="w-full md:w-1/2 py-5 md:px-5 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                            <div class="px-6 py-10 bg-white shadow rounded">
                                <div class="flex items-center mb-4">
                                    <img class="h-16 w-16 rounded-full object-cover" src="assets/imgs/placeholders/img-2.jpg" alt="Product Comparify" />
                                    <div class="pl-4">
                        ...
                        <div class="w-full md:w-1/2 py-5 md:px-5 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                            <div class="px-6 py-10 bg-white shadow rounded">
                                <div class="flex items-center mb-4">
                                    <img class="h-16 w-16 rounded-full object-cover" src="assets/imgs/placeholders/img-5.jpg" alt="Product Comparify" />
                                    <div class="pl-4">
                        ...
                        <div class="w-full md:w-1/2 py-5 md:px-5 wow animate__animated animate__fadeIn" data-wow-delay=".7s">
                            <div class="px-6 py-10 bg-white shadow rounded">
                                <div class="flex items-center mb-4">
                                    <img class="h-16 w-16 rounded-full object-cover" src="assets/imgs/placeholders/img-6.png" alt="Product Comparify" />
                                    <div class="pl-4">
